        ...
        <section className="w-full bg-white py-12 px-4 md:px-12">
            <div className="md:max-w-3xl lg:max-w-5xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10">
                ...
                <div className="w-full md:w-1/2 space-y-6">
                    ...
                    <button className="text-white px-6 py-2 rounded-full text-sm bg-purple-700 hover:bg-purple-800 transition wow animate__animated animate__fadeInLeft" data-wow-delay="0.7s">
                        KNOW MORE
                    </button>
                </div>
