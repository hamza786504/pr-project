    ...
    return (
        <section className="w-full bg-white pt-12 pb-24 px-4 md:px-16">
            <div className="md:max-w-3xl lg:max-w-5xl mx-auto">
                ...
                .wave-item {
                    animation: verticalWave 10s ease-in-out infinite;
                }
            `}</style>
                ...
                >
                    ...
                    >
                        {images.map((img, index) => (
                            <div
                                key={index}
                                className="carousel-item inline-flex items-center justify-center mx-5 space-y-5 flex-col"
                            >
                                <div className={`wave-item ${index % 2 === 0 ? "w-35 h-35" : "w-40 h-40"}  flex items-center justify-center p-2 bg-white rounded-full shadow-lg overflow-hidden`}
                                    style={{
